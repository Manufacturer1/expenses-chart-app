  ...
  return (
   ...
   <div className='max-w-xl mx-auto p-5 flex flex-col justify-center h-screen'>
    <article className='soft-red p-8 rounded-2xl shadow flex items-center justify-between'>
      <h2 className='font-bold text-white text-3xl'><span className='block text-base font-normal'>My balance</span>$921.48
      </h2>
    ...
    <article className='pt-8 border-t border-slate-200 flex items-end justify-between'>
